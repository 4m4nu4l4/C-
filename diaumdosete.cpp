 ...
 do{
    ...
    while ((escolha=='S')|| (escolha=='s')) {
       if (escolha == 'N' || escolha == 'n') {
        ...
        if (rolo1 == rolo2 && rolo2 == rolo3 && rolo3 == rolo4 && rolo2 == rolo4 && rolo1 == rolo4 ) {
            ...
            Jogador.creditos = Jogador.creditos + 5; 
        } else {
        ...
        if (Jogador.creditos <= 0){
        	
        	cout << "Seus créditos acabaram!";
        	Jogador.creditos = 0;
        	
        	cout << "Pressione X para sair.\n";
        	cin >> escolha;
